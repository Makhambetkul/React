function runA1() {
    ...
    Rectangle.prototype.describe = function(){
        const parentDescribe=Shape.prototype.describe(this);
        return parentDescribe+" Rectangle "+this.width+"x"+this.height;
    ...
    Square.prototype.describe = function(){ 
        const parentDescribe=Rectangle.prototype.describe.call(this);
        return parentDescribe+" Square side="+this.width;
    };
